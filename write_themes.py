...
with open('apps/web/src/lib/themes.ts', 'w', encoding='utf-8') as f:
    f.write(content)

# 확인
with open('apps/web/src/lib/themes.ts', 'r', encoding='utf-8') as f:
    text = f.read()

theme_count = text.count('primary:')
print(f"themes.ts 작성 완료 - primary 필드 수: {theme_count} (9개 테마면 9개)")
