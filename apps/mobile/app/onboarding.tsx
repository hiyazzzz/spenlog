  ...
  async function finish() {
    ...
    try {
      ...
      await supabase.from('users').upsert(
        { id: uid, name: finalName, income: incomeNum, saving_goal: goalNum, theme, onboarding_completed: true },
        { onConflict: 'id' },
      );
  ...
  return (
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.progressBarBg}>
        <View style={[styles.progressBarFill, { width: `${(step / TOTAL_STEPS) * 100}%` as any }]} />
      </View>
